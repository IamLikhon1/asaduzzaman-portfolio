...
const Projects = () => {
    return (
        ...
        <div className="card-body">
            ...
            <p className='text-xl my-3'>WorkJet</p>
            <div className='grid grid-cols-2'>
               <button className='mx-1 tooltip mt-4 tooltip-warning'data-tip="Website-Live-Link">
                <a className='flex items-center text-lg font-semibold hover:text-orange-400 duration-500' href="https://meek-starburst-bd6984.netlify.app/"target='blank'>Live Link <FiExternalLink className='items-center mt-1'></FiExternalLink>

                </a>
                </button>
               <button className='mx-1 tooltip mt-4 tooltip-warning'data-tip="Client-Github-Site">
                <a className='flex items-center text-lg font-semibold hover:text-orange-400 duration-500' href="https://github.com/IamLikhon1/job-hunter" target='blank'>Client<FiGithub className='items-center mt-1 '></FiGithub>
