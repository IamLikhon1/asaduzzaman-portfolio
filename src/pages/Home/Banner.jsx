        ...
        <div className='mx-2'>
            <div className="grid md:grid-cols-2 items-center md:mx-10">
                ...
                <div className=''>
                    ...
                    <button onClick={handleResumeDownload} className=' button btn bg-[#FFA500] hover:bg-[#FFA500] mt-5 text-white rounded-xl' data-aos="fade-down"
                        data-aos-easing="linear"
                        data-aos-duration="1500"><FaDownload className='text-white'></FaDownload>Download My Resume</button>
                    <div className="mt-10 text-4xl " data-aos="fade-down"
                        data-aos-easing="linear"
